...
struct remoteproc_priv {
	const char *kick_dev_name; /**< shared memory device name */
	const char *kick_bus_name; /**< shared memory bus name */
	struct metal_device *kick_dev; /**< pointer to poll mem device */
	struct metal_io_region *kick_io; /**< pointer to poll mem i/o */
};

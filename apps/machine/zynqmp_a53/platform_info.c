...
#define POLL_DEV_NAME         "poll_dev"
#define POLL_BUS_NAME         "generic"
...
static struct remoteproc_priv rproc_priv = {
	.kick_dev_name = POLL_DEV_NAME,
	.kick_bus_name = POLL_BUS_NAME,
};
...
/* processor operations from a53 to r5. It defines
 * notification operation and remote processor management operations. */
extern struct remoteproc_ops zynqmp_a53_r5_proc_ops;
...
platform_create_proc(int proc_index, int rsc_index)
{
	...
	(void)metal_register_generic_device(&poll_device);
	/* Initialize remoteproc instance */
	if (!remoteproc_init(&rproc_inst, &zynqmp_a53_r5_proc_ops, &rproc_priv))
		return NULL;
